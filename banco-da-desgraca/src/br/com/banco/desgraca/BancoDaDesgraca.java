...
public class BancoDaDesgraca {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\n > Verificando extrato da Conta Poupança Bradesco no período de 01/01/2020 a 25/02/2021 (devem aparecer 3 registros)...");
        bradescoPoupanca.exibirExtrato(LocalDate.of(2020, 1, 1), LocalDate.of(2021, 2, 25));
