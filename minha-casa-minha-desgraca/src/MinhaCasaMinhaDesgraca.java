...
public class MinhaCasaMinhaDesgraca {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Endereco rs = new Endereco("Rua Leonel Theodorico Alvim","498","Lagoa Armênia",
                "Centro","Taquari",UnidadeFederativa.RIO_GRANDE_DO_SUL);
        Endereco sp = new Endereco("Carlos Lima","111","","Praia",
                "São Paulo",UnidadeFederativa.SAO_PAULO);
        ...
        Beneficiario carlos = new Beneficiario("Carlos Braga", 5000d);
        ...
        PropostaFinanciamento financiamento = new PropostaFinanciamento(beneficiario,
                                                                imovelEscolhido, mesesParaPagamento);
